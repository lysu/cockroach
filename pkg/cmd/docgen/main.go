...
func main() {
	...
	//	}
	//}
	//b, err:= RunBNF("/home/robi/Code/go/src/github.com/cockroachdb/cockroach/pkg/sql/parser/sql.y")
	//genBNF("/home/robi/Code/go/src/github.com/pingcap/parser/parser.y", "", topStmt, false, write, "/home/robi/bnf")
	b, e := RunBNF("/home/robi/Code/go/src/github.com/pingcap/parser/parser.y")
	if e != nil {
		panic(e)
	}
...
func init() {
	...
	cmdBNF := &cobra.Command{
		...
		Run: func(cmd *cobra.Command, args []string) {
			bnfDir := args[0]
			genBNF(addr, filter, topStmt, invertMatch, write, bnfDir)
		},
	}
...
func genBNF(addr string, filter string, topStmt string, invertMatch bool, write func(name string, data []byte), bnfDir string) {
	bnf, err := RunBNF(addr)
	if err != nil {
		log.Fatal(err)
	}
